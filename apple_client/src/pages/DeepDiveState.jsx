...
const DeepDiveState = ({ location, topic, onLocationChange, onTopicChange, onView, onClear }) => {
  return (
    <div className="filter-container">
      <div className="filter-group">
        <label htmlFor="location">Location:</label>
        <select id="location" className="custom-select" value={location} onChange={onLocationChange}>
          <option>All states, DC, and territories</option>
